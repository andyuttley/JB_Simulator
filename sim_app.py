...
if show_lk_ranks:
        results_to_date['Luck Adjusted Pts'] = np.where(results_to_date['GW_rank']<7.5, 0.5, 0)
        results_to_date['Luck Adjusted Pts'] = np.where(results_to_date['GW_rank']<6.5, 1, 0)
